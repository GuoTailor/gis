...
public class FFMPEGUtil {
    ...
    public static void main(String[] args) throws Exception {
        ...
        String url = "F:\\迅雷下载\\Lone.Survivor.2013.BluRay.1080p.x264.DD5.1-HDWinG.mkv";
        ...
        //图片输出宽度
        int outWidth = videoAvStream.codecpar().width();
        //图片输出高度
        int outHeight = videoAvStream.codecpar().height();
        ...
        //---初始化像素转换的存储对象
        int numBytes = av_image_get_buffer_size(AV_PIX_FMT_YUVJ420P, outWidth, outHeight, 1);
        ...
        while (flag) {
            ...
            while (true) {
                ...
                if (temp == videoCodecCtx) {
                    ...
                    pos = Double.valueOf(cutStartTime / av_q2d(videoAvStream.time_base())).longValue();
                    av_seek_frame(avFormatContext, videoStreamIndex, pos, AVSEEK_FLAG_BACKWARD);
                    break;
                }
